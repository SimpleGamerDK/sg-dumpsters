...
AddEventHandler('sg-dumpsters:dumpsterBrown',function()
    ...
    Wait(1000)
	TriggerEvent('inventory:openStorage', "Dumpster", "dumpsterbrown-1", 350, 1000)
...
AddEventHandler('sg-dumpsters:dumpsterBlue',function()
	...
	exports['progressBars']:startUI(1000, "Opening Dumpster")
    Wait(1000)
	TriggerEvent('inventory:openStorage', "Dumpster", "dumpsterblue-1", 350, 1000)
	AddEventHandler("inventory:close", function()
		ClearPedTasks(GetPlayerPed(-1))
	end)	
end)
...
AddEventHandler('sg-dumpsters:dumpsterGreen',function()
	...
	exports['progressBars']:startUI(1000, "Opening Dumpster")
    Wait(1000)
	TriggerEvent('inventory:openStorage', "Dumpster", "dumpstergreen-1", 350, 1000)
	AddEventHandler("inventory:close", function()
		ClearPedTasks(GetPlayerPed(-1))
	end)	
end)
...
AddEventHandler('sg-dumpsters:dumpsterYellow',function()
	...
	exports['progressBars']:startUI(1000, "Opening Dumpster")
    Wait(1000)
	TriggerEvent('inventory:openStorage', "Dumpster", "dumpsteryellow-1", 350, 1000)
	AddEventHandler("inventory:close", function()
		ClearPedTasks(GetPlayerPed(-1))
	end)	
end)
...
AddEventHandler('sg-dumpsters:dumpsterBlueTwo',function()
	...
	exports['progressBars']:startUI(1000, "Opening Dumpster")
    Wait(1000)
	TriggerEvent('inventory:openStorage', "Dumpster", "dumpsterbluetwo-1", 350, 1000)
	AddEventHandler("inventory:close", function()
		ClearPedTasks(GetPlayerPed(-1))
	end)	
end)
...
AddEventHandler('sg-dumpsters:dumpsterGreenTwo',function()
	...
	exports['progressBars']:startUI(1000, "Opening Dumpster")
    Wait(1000)
	TriggerEvent('inventory:openStorage', "Dumpster", "dumpstergreentwo-1", 350, 1000)
	AddEventHandler("inventory:close", function()
		ClearPedTasks(GetPlayerPed(-1))
	end)	
end)